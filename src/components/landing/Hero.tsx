const Hero = () => {
  return (
    <section id='home' className='bg-white dark:bg-gray-900'>
      <div className='grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-52 lg:grid-cols-12 lg:pt-36'>
        <div className='mr-auto place-self-center lg:col-span-7'>
          <h1 className='max-w-2xl mb-4 text-4xl font-extrabold  md:text-5xl dark:text-white'>
            Empower your success <br />
            Measure your excellence & Productivity
          </h1>
          <p className='max-w-2xl mt-8 mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400'>
            ...
            and efficiency. Utilizing artificial intelligence tools and
