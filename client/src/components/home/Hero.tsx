...
const Hero = () => {
  ...
  return (
    <div className='grid grid-cols-1 md:grid-cols-3 gap-4 p-4 max-w-7xl mx-auto pt-28'>
      {/* Hero Section - Updated gradient and colors */}
      <div className='md:col-span-2 bg-gradient-to-br from-primary to-primary/80 rounded-3xl p-8 text-primary-foreground'>
        ...
        <button
          ...
          className='bg-background text-primary hover:bg-accent px-6 py-3 rounded-lg font-semibold transition-all'
        >
          Get Started
        </button>
      </div>
      ...
      <div className='bg-card/60 backdrop-blur-lg rounded-3xl p-6 text-card-foreground border border-border/50'>
      ...
      <div className='md:col-span-2 bg-card/60 backdrop-blur-lg rounded-3xl p-6 text-card-foreground border border-border/50'>
